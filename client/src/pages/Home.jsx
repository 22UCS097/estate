  ...
  return (
    <div>
      ...
      <div className="text-gray-400 text-xs sm:text-sm">
         the best palce where you can 
         buy ans sell the houses and many more 
         functionlity that having
         <br/>
         dmic cbnklsc cjnl oijn;aicjm lmc
      </div>
      ...
      {/* listing result for offer sale and rent */}
       ...
       <div className="max-w-6xl mx-auto p-3 flex-col gap-8 my-10">
         ...
         offerListings && offerListings.length>0 &&(
                <div className="">
                   <div className="my-3">
                      <h2 className='text-2xl font-semibold text-slate-600'>recente offers</h2>
         ...
         rentListings && rentListings.length>0 &&(
                <div className="">
                   <div className="my-3">
                      <h2 className='text-2xl font-semibold text-slate-600'>recente places for rent</h2>
